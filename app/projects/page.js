...
const Projects = () => {
  return (
    <div className={styles.containear}>
      <div className={styles.head}>My Projects</div>
      <div className={styles.bodyContainear}>
        <div className={styles.imgContainear}>
          ...
          <div className={styles.text}>
            <h3>Quiz Academy</h3>
            <a href="https://quiz-quick-theta.vercel.app/" target="_blank">
              <button className={styles.text0}>
                Go Now <span className={styles.rigthAnimationIcon}>&raquo;</span>
              </button>
            </a>
          </div>
        </div>
