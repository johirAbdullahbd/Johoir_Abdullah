    ...
    <div className={styles.bodyContainear}>
      <div className={styles.tex}>
        <p>
          ...
          which will have global exposure in the future. These projects allowed me to learn new things and I took every challenge to improve myself. I
          like to be busy with work and learning new things and I am ready to face any challenge in new situations anytime.
        </p>
      </div>
